        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text20">Testimonials</span>
                </Fragment>
              )}
            </a>
            <div
                      ...
                      <div className="navbar8-menu-item1">
                        ...
                        <div className="navbar8-content1">
                          <span className="navbar8-page11 thq-body-large">
                            {props.page1 ?? (
                              <Fragment>
                                <span className="navbar8-text27">Page One</span>
                              </Fragment>
                            )}
                          </span>
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text19">Page Three</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text17">Page Four</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  logoAlt: 'Handyman Services Logo',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1699040309386-11c615ed64d5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTcwMzEzN3w&ixlib=rb-4.1.0&q=80&w=1080',
  link3: undefined,
  page2: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1611591594311-6eb9b7c7e340?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTcwMzEzNnw&ixlib=rb-4.1.0&q=80&w=1080',
  page4Description: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1731691511976-0a628ab90324?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTcwMzEzNnw&ixlib=rb-4.1.0&q=80&w=1080',
  link1Url: 'https://www.teleporthq.io',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1576496651823-ff288474332b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MTcwMzEzN3w&ixlib=rb-4.1.0&q=80&w=1080',
